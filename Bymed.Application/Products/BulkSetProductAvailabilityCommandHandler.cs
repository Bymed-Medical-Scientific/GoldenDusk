...
public sealed class BulkSetProductAvailabilityCommandHandler : IRequestHandler<BulkSetProductAvailabilityCommand, Result<BulkOperationResultDto>>
{
    private readonly IProductRepository _productRepository;
    private readonly IUnitOfWork _unitOfWork;
    private readonly ICatalogReadCache _catalogReadCache;

    public BulkSetProductAvailabilityCommandHandler(
    ...
    public async Task<Result<BulkOperationResultDto>> Handle(BulkSetProductAvailabilityCommand request, CancellationToken cancellationToken)
    {
