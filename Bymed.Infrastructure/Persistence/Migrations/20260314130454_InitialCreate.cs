...
{
    /// <summary>
    /// Initial schema: Categories, Users, PageContents, Products, ProductImages, Carts, CartItems,
    /// Orders (with owned ShippingAddress), OrderItems, Addresses, ContentVersions, InventoryLogs.
    /// Includes FKs (Category-Product Restrict, User cascades/set null), indexes, and jsonb for Product.Specifications.
    /// </summary>
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Metadata_MetaTitle = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    Metadata_MetaDescription = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    Metadata_OgImage = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContentVersions_PageContents_PageContentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductImageUrl = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false),
                    Quantity = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContentVersions_PageContentId",
                table: "ContentVersions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PageContents_PublishedAt",
                table: "PageContents",
                column: "PublishedAt");
